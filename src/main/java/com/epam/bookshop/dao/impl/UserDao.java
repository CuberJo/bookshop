...
public class UserDao extends AbstractDao<Long, User> {
    ...
    private static final String SQL_DELETE_USER_BY_ID = "DELETE FROM BOOKSHOP.LIBRARY_USER WHERE Id = ?;";
    private static final String SQL_UPDATE_USER_BY_ID = "UPDATE BOOKSHOP.LIBRARY_USER SET Name = ?, Login = ?, Password = ?, Email = ?, Admin = ? WHERE Id = ?;";
    private static final String SQL_SELECT_ALL_USERS = "SELECT Id, Name, Login, Password, Email, Admin FROM BOOKSHOP.LIBRARY_USER ";
    private static final String SQL_SELECT_USER_BY_ID = "SELECT Id, Name, Login, Password, Email, Admin FROM BOOKSHOP.LIBRARY_USER WHERE Id = ?";
    private static final String SQL_SELECT_COUNT_ALL = "SELECT COUNT(*) as Num FROM BOOKSHOP.LIBRARY_USER;";
    private static final String SQL_INSERT_USER_BANK_ACCOUNT = "INSERT INTO BOOKSHOP.USER_BANK_ACCOUNT (Library_User_Id, IBAN) VALUES (?, ?);";
    private static final String SQL_SELECT_ALL_USERs_IBANS = "SELECT Library_User_Id, IBAN FROM BOOKSHOP.USER_BANK_ACCOUNT;";
    private static final String SQL_SELECT_ALL_USER_IBANS_BY_LIBRARY_USER_ID = "SELECT Library_User_Id, IBAN FROM BOOKSHOP.USER_BANK_ACCOUNT WHERE Library_User_Id = ?;";
    private static final String SQL_DELETE_USER_IBAN_BY_IBAN = "DELETE FROM BOOKSHOP.USER_BANK_ACCOUNT WHERE IBAN = ?;";
    private static final String SQL_SELECT_ALL_USERS_BY_LIMIT = "SELECT Id, Name, Login, Password, Email, Admin FROM BOOKSHOP.LIBRARY_USER LIMIT ?, ?";
