var cardValidator = function (e) {
    ...
    var i = a(1), d = t(i), s = a(2), u = t(s), o = a(3), c = {
        querySelectors: {logo: "#card-logo", label: "#card-label", cardNumber: "#card_number"},
        errorMessage: "Tarjeta invalida"
    }, m = function () {
        var e = document.querySelector(c.querySelectors.logo), r = document.querySelector(c.querySelectors.cardNumber);
        ...
        var r = "", a = (0, o.trimAllSpaces)(e.value);
        if (!a) return !1;
        for (var t in d.default) if (d.default.hasOwnProperty(t) && d.default[t].predict.test(a)) {
        ...
        for (var a in d.default) if (d.default[a].regex.test(r)) return !!n(r) && a
    }, f = function (e, r) {
        e && (r ? (e.classList.remove("error"), e.classList.add("validcard")) : (e.classList.add("error"), e.classList.remove("validcard")))
    };
    ...
    var n = function (e) {
        ...
        var a = [].concat(t(r)), n = [].concat(t(e.replace(/\s/g, ""))), i = [];
